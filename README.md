...
| [DreamHearth](dreamhearth/) | Modular nest-and-shell bedding system. A right to rest. | Active |
...
└── dreamhatchery/          ← DreamHatchery · DreamHearth DiscoveryDome module (coming)
```
...
- **DiscoveryMode** — SunHearth Circle of Warmth is a DiscoveryMode-compatible classroom inquiry. DreamHatchery (coming) is a DiscoveryDome module for ethical insect observation and release.
